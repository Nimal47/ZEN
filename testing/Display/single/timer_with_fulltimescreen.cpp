      ...
      // --- MODE 1: TIMER INTERFACE ---
        ...
        // PHASE B: TIMER IS ACTIVELY RUNNING
          ...
          if (remainingSeconds > 0) {
            ...
            // --- THE MAGIC LINE ---
            // Actively trick the OS into thinking motion is happening right now
            // so the screen NEVER goes to sleep while counting down!
          ...
          // PHASE C: TIME IS UP
            ...
            // Draw this if it just hit 0, or if you walked away and came back to see it
